    ...
    <script type="text/javascript" defer>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Task', 'Hours per Day'],
          ['trabalhar',  <?php echo $dados['trabalho'] ?>],
          ['comer',      <?php echo $dados['comer'] ?>],
          ['conversar',  <?php echo $dados['conversar'] ?>],
          ['Dormir',     <?php echo $dados['dormir'] ?>]
        ]);
            <?php }?>
        var options = {
